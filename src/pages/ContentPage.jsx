...
export const ContentPage = () => {
  ...
  useEffect(() => {
    ...
    const movieVideoUrl = `https://api.themoviedb.org/3/movie/${id}/videos?api_key=5d55a3cba36b527e0435c9a070f8f04f`;
    ...
    const movieKeywordsUrl = `https://api.themoviedb.org/3/movie/${id}/keywords?api_key=5d55a3cba36b527e0435c9a070f8f04f`;
    axios.get(movieKeywordsUrl).then((response) => {
      setMovieKeywords(response.data);
    });
    const movieActorsUrl = `https://api.themoviedb.org/3/movie/${id}/credits?api_key=5d55a3cba36b527e0435c9a070f8f04f&language=en-US`;
    ...
    <div className="movie-page container">
      <div className="main-details">
        ...
        <div className="movie_info">
          <h1 className="movie_title">{movieInfo.original_title}</h1>
          ...
          <div className="detail-wrapper">
            ...
            <div className="detail-info">
              {movieInfo.release_date != null ? (
                <p>
                  {movieInfo.release_date.charAt(8) != "0"
                    ? movieInfo.release_date.substring(8, 10)
                    : movieInfo.release_date.substring(9, 10)}{" "}
                  {movieInfo.release_date.substring(5, 7) == "01" ? (
                    <span>January,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "02" ? (
                    <span>February,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "03" ? (
                    <span>March,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "04" ? (
                    <span>April,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "05" ? (
                    <span>May,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "06" ? (
                    <span>June,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "07" ? (
                    <span>July,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "08" ? (
                    <span>August,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "09" ? (
                    <span>September,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "10" ? (
                    <span>October,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "11" ? (
                    <span>November,</span>
                  ) : (
                    <></>
                  )}{" "}
                  {movieInfo.release_date.substring(5, 7) == "12" ? (
                    <span>December,</span>
                  ) : (
                    <></>
                  )}
              ...
              {movieInfo.length != 0 ? (
                <p>
                  {movieInfo.production_countries[0] != undefined
              ...
              {movieInfo.length != 0 ? (
                <p>
                  {movieInfo.production_companies[0] != undefined
      ...
      <div className="main-details-mobile">
        ...
        >
          <h1 className="movie_title shadow">{movieInfo.original_title}</h1>
        </div>
        <div className="detail-category">
          {movieInfo.release_date != null ? (
            <p>
      ...
      <div className="cast">
        <div className="between">
          ...
          <NavLink className="navlink" to={`/movies/cast/${id}`}>
      ...
      <div className="media">
        <div className="between">
          ...
          <NavLink className="navlink" to={`/movies/media/${id}`}>
            <h2 className="see-all pointer detail">See All</h2>
          </NavLink>
        </div>
        <div
      ...
      <div className="recommendations">
        <div className="between">
          ...
          <NavLink className="navlink" to={`/movies/recommendations/${id}`}>
            <h2 className="see-all pointer detail">See All</h2>
          </NavLink>
        </div>
        <div
